package site.fish119.oauth2server.service;
...
import site.fish119.oauth2server.po.User;
...
public class UserService implements UserDetailsService {
    ...
    public void initData() {
        ...
        userList.add(new User("andy", password, AuthorityUtils.commaSeparatedStringToAuthorityList("guest")));
